...
if ($page != basename($_SERVER['SCRIPT_FILENAME'], '.php')) {
    header('Location: /cctrepositorysystem/funcadmin_fileupload_view_scs.php');
    exit();
}
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800">School of Computer Studies<small class="h5 mb-4 text-gray-500"> view school of computer studies research papers</small></h1>
    <small><p><i class="fas fa-fw fa-home fa-1x"></i><a href="admindashboard.php" class='text-gray-700'>&nbsp;&nbsp;Home</a>&nbsp;&nbsp;>&nbsp;&nbsp; SCS Research Papers</p></small>
  </div>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            $sql = "SELECT * FROM tb_fuploads WHERE fup_department = 'School of Computer Studies' AND fup_status = 'Posted' ";
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  $('.truncate').each(function() {
    var $this = $(this);
    var $seeMore = $('<a href="funcadmin_fileupload_view_scs.php" class="see-more"> See more</a>');
