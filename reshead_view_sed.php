...
if ($page != basename($_SERVER['SCRIPT_FILENAME'], '.php')) {
    header('Location: /cctrepositorysystem/reshead_view_sed.php');
    exit();
}
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between">
    ...
    <small><p><i class="fas fa-fw fa-home fa-1x"></i><a href="researchheaddashboard.php" class='text-gray-700'>&nbsp;&nbsp;Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;School of Education</p></small>
  </div>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  $('.truncate').each(function() {
    var $this = $(this);
    var $seeMore = $('<a href="reshead_view_sed.php" class="see-more"> See more</a>');
