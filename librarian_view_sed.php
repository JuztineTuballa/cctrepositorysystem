...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between">
    <h1 class="h4 mb-4 text-gray-800">School of Education<small class="h4 mb-4 text-gray-500"> view school of education research papers</small></h1>
    <small><p><i class="fas fa-fw fa-home fa-1x"></i><a href="librariandashboard.php" class='text-gray-700'>&nbsp;&nbsp;Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;School of Education</p></small>
  </div>
