...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="./librariandashboard.php">
...
<li class="nav-item active">
  <a class="nav-link" href="librariandashboard.php">
...
<li class="nav-item">
  <a class="nav-link" href="librarian_settings.php" >
...
<li class="nav-item">
  <a class="nav-link" href="librarian_view_scs.php" >
    <i class="fas fa-fw fa-file-pdf"></i>
    <span>SCS Research Papers</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link" href="librarian_view_sed.php" >
    <i class="fas fa-fw fa-file-pdf"></i>
    <span>SED Research Papers</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link" href="librarian_view_sbm.php" >
    <i class="fas fa-fw fa-file-pdf"></i>
    <span>SBM Research Papers</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link" href="librarian_view_shtm.php" >
    <i class="fas fa-fw fa-file-pdf"></i>
    <span>SHTM Research Papers</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link" href="lib_stud_req_approval.php">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            $sesid = $_SESSION['librarian_picture'];

            $sql = "SELECT * FROM tb_librarian WHERE librarian_picture = '".$sesid."' ";
          ...
          <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="librarian_settings.php">
              <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
              Settings
            </a>
            <a class="dropdown-item" href="lib_stud_req_archived.php">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <form action="cct_faculty_logout.php" method="POST"> 
              ...
              <button type="submit" name="lb_logout_btn" class="btn btn-primary">Logout</button>
