...
if ($page != basename($_SERVER['SCRIPT_FILENAME'], '.php')) {
    header('Location: /cctrepositorysystem/cct_admin_signin.php');
    exit();
}
...
<?php
include "includes/admin-signin-header.php";
?>
...
<body>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <img src="./a-images/cct-admin.png" style="height: 50px;"> 
                  ...
                  <form action="cct_admin.php" class="user" method="POST">
                  ...
                  <div class="text-center">
                    <div class="form-group">
                     	<a href="z-admin-forgot-password-page.php"> Forgot your Password?</a></p> 
                    </div>
                  </div>
                </div>
              </div>
  ...
  <?php
  include 'includes/admin-signin-footer.php';
  ?>
