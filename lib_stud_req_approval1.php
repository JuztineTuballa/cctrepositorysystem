...
if ($page != basename($_SERVER['SCRIPT_FILENAME'], '.php')) {
    header('Location: /cctrepositorysystem/lib_stud_req_approval1.php');
    exit();
}
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <a href="lib_stud_req_approval1.php" class="text-primary"></i>Approved Student Requests</a> 
    &nbsp;&nbsp;<code class="text-secondary">|</code>&nbsp;&nbsp;
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              ...
              <th>
                <button type="submit" name="stud_archive_all_multiple_btn"  class="btn mx-1"><i class="fas fa-archive"></i></button>
	            ...
	            while($row = $query->fetch_assoc()) {
	              ...
	              <tr>
	                ...
	                <td style='width:10px; text-align: center;'>
	                  <input type='checkbox' name='stud_auto_archive[]' value='".$row['req_id']."' />
	                </td>
	                </form>
