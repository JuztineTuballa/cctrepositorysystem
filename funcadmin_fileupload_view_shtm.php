...
if ($page != basename($_SERVER['SCRIPT_FILENAME'], '.php')) {
    header('Location: /cctrepositorysystem/funcadmin_fileupload_view_shtm.php');
    exit();
}
...
<div class="container-fluid">
  ...
  <!--<h1 class="h3 mb-4 text-gray-800" id="adminheader">Research Head<small class="h4 mb-4 text-gray-500"> view research head profile information</small></h1>-->
  <!--<hr class="sidebar-divider">-->
 
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800">School of Hospitalty and Tourism Management<small class="h5 mb-4 text-gray-500"> view school of education research papers</small></h1>
    <small><p><i class="fas fa-fw fa-home fa-1x"></i><a href="admindashboard.php" class='text-gray-700'>&nbsp;&nbsp;Home</a>&nbsp;&nbsp;>&nbsp;&nbsp; SHTM Research Papers</p></small>
  </div>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  $('.truncate').each(function() {
    var $this = $(this);
    var $seeMore = $('<a href="funcadmin_fileupload_view_shtm.php" class="see-more"> See more</a>');
